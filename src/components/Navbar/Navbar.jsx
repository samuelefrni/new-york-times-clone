  ...
  return (
    <>
      <nav className={NavbarCSS.nav}>
        <section className={NavbarCSS.containerLanguage}>
          <ul className={NavbarCSS.ulLanguage}>
            ...
            <a href="https://www.nytimes.com/ca/">
              <li>Canada</li>
            </a>
        ...
        <CiSearch
          className={isOpen ? NavbarCSS.iconClose : NavbarCSS.searchIcon}
          onClick={handleClick}
        />
        <IoMdMenu
          className={isOpen ? NavbarCSS.iconClose : NavbarCSS.menuIcon}
          onClick={handleClick}
        />
        {isOpen ? (
          <IoIosClose
        ...
        <a href="https://myaccount.nytimes.com/auth/login">
      ...
      <form
        ...
        className={isOpen ? NavbarCSS.form : NavbarCSS.isClose}
      >
        <input
      ...
      {pathname === "/" || pathname.slice(0, 8) === "/section" ? null : (
        <>
